...
class TinyMT:
    ...
    def untwist(self):
        ...
        The last bit can then be recovered by checking if the resulting state/vector belongs to the TinyMT vector space using it's Cartesian equation.
        """
        if self.s3 & 1:
            self.s1 ^= 0x8F7011EE
            self.s2 ^= 0xFC78FF1F
...
# https://github.com/StarfBerry/PokeRNG/blob/1e91b74e5235a09c3cc369c04a771ce0b78ef7f6/Math/GF2_Computation.py#L151
TINYMT_JUMP_TABLE = (
